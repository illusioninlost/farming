...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference('Farmer.count') do
      post farmers_url, params: { farmer: { name: @farmer.name, password_digest: @farmer.password_digest, username: @farmer.username } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { name: @farmer.name, password_digest: @farmer.password_digest, username: @farmer.username } }
